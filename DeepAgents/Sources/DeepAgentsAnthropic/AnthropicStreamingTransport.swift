...
/// The injectable transport ``AnthropicTurnSession`` streams a Messages response through.
...
/// (A self-contained copy of DeepAgentsOpenAI's transport so the adapter stays independent.)
public protocol AnthropicStreamingTransport: Sendable {
...
public struct URLSessionStreamingTransport: AnthropicStreamingTransport {
